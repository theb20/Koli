...
const SECTIONS = [
  {
    ...
    content: (
      <>
        <P>
          <Strong>Dropship SAS</Strong> (ci-après « Dropship », « nous ») est responsable du
          traitement des données personnelles collectées via la plateforme dropship.fr et ses
                ...
                <tr key={f} className="border-t border-gray-100">
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-flex rounded-full px-2.5 py-0.5 text-[11px] font-semibold ${
                      b === "Consentement"         ? "bg-blue-50 text-blue-700"
                      : b === "Obligation légale (7 ans)" || b === "Obligation légale"
                                                    ? "bg-amber-50 text-amber-700"
                      : b === "Exécution du contrat" ? "bg-green-50 text-green-700"
    ...
    content: (
      <>
        ...
        <P>
          ...
          <a href="mailto:dpo@dropship.fr" className="font-medium text-blue-600 underline underline-offset-2">
            dpo@dropship.fr
          </a>
          {" "}ou par courrier à Dropship SAS – DPO, 42 rue du Commerce, 75015 Paris.
        ...
        <InfoBox variant="blue">
          ...
          — <a href="https://www.cnil.fr" target="_blank" rel="noreferrer" className="font-medium underline underline-offset-2">www.cnil.fr</a>.
        </InfoBox>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <P>
          ...
          <a href="mailto:privacy@dropship.fr" className="text-blue-600 underline underline-offset-2">
            privacy@dropship.fr
          </a>{" "}
  ...
  },
  {
    ...
    content: (
      <>
        <P>
          Dropship se réserve le droit de modifier la présente politique à tout moment.
  ...
  return (
    <>
      <PageMeta
        ...
        description="Comment Dropship collecte, utilise et protège vos données personnelles. Vos droits RGPD, durées de conservation et contact DPO."
        path="/privacy"
      />
      <LegalLayout
