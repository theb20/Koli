...
exports.HomepageServiceClient = void 0;
 ...
 */
const gapicConfig = require("./homepage_service_client_config.json");
...
class HomepageServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.HomepageService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.homepageServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.HomepageService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.HomepageService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const homepageServiceStubMethods = ['getHomepage', 'updateHomepage', 'claimHomepage', 'unclaimHomepage'];
        for (const methodName of homepageServiceStubMethods) {
            const callPromise = this.homepageServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getHomepage(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateHomepage(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    claimHomepage(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    unclaimHomepage(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.HomepageServiceClient = HomepageServiceClient;
//# sourceMappingURL=homepage_service_client.js.map