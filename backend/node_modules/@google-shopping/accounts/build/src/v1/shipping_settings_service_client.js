...
exports.ShippingSettingsServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/shipping_settings_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./shipping_settings_service_client_config.json");
...
class ShippingSettingsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.ShippingSettingsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.shippingSettingsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.ShippingSettingsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.ShippingSettingsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const shippingSettingsServiceStubMethods = ['getShippingSettings', 'insertShippingSettings'];
        for (const methodName of shippingSettingsServiceStubMethods) {
            const callPromise = this.shippingSettingsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getShippingSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    insertShippingSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.ShippingSettingsServiceClient = ShippingSettingsServiceClient;
//# sourceMappingURL=shipping_settings_service_client.js.map