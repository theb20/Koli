...
exports.OmnichannelSettingsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./omnichannel_settings_service_client_config.json");
...
class OmnichannelSettingsServiceClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('accounts');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            accountIssuePathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/issues/{issue}'),
            accountRelationshipPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/relationships/{relationship}'),
            accountServicePathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/services/{service}'),
            autofeedSettingsPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/autofeedSettings'),
            automaticImprovementsPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/automaticImprovements'),
            businessIdentityPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/businessIdentity'),
            businessInfoPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/businessInfo'),
            checkoutSettingsPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/programs/{program}/checkoutSettings'),
            developerRegistrationPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/developerRegistration'),
            emailPreferencesPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/users/{email}/emailPreferences'),
            gbpAccountPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/gbpAccounts/{gbp_account}'),
            homepagePathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/homepage'),
            lfpProviderPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/omnichannelSettings/{omnichannel_setting}/lfpProviders/{lfp_provider}'),
            omnichannelSettingPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/omnichannelSettings/{omnichannel_setting}'),
            onlineReturnPolicyPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/onlineReturnPolicies/{return_policy}'),
            programPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/programs/{program}'),
            regionPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/regions/{region}'),
            shippingSettingsPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/shippingSettings'),
            termsOfServicePathTemplate: new this._gaxModule.PathTemplate('termsOfService/{version}'),
            termsOfServiceAgreementStatePathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/termsOfServiceAgreementStates/{identifier}'),
            userPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/users/{email}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listOmnichannelSettings: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'omnichannelSettings')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.OmnichannelSettingsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.omnichannelSettingsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.OmnichannelSettingsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.OmnichannelSettingsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const omnichannelSettingsServiceStubMethods = ['getOmnichannelSetting', 'listOmnichannelSettings', 'createOmnichannelSetting', 'updateOmnichannelSetting', 'requestInventoryVerification'];
        for (const methodName of omnichannelSettingsServiceStubMethods) {
            const callPromise = this.omnichannelSettingsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getOmnichannelSetting(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createOmnichannelSetting(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateOmnichannelSetting(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    requestInventoryVerification(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listOmnichannelSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    listOmnichannelSettingsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listOmnichannelSettings.createStream(this.innerApiCalls.listOmnichannelSettings, request, callSettings);
    }
    /**
     ...
     */
    listOmnichannelSettingsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listOmnichannelSettings.asyncIterate(this.innerApiCalls['listOmnichannelSettings'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.OmnichannelSettingsServiceClient = OmnichannelSettingsServiceClient;
//# sourceMappingURL=omnichannel_settings_service_client.js.map