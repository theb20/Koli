...
exports.GbpAccountsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./gbp_accounts_service_client_config.json");
...
class GbpAccountsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listGbpAccounts: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'gbpAccounts')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.GbpAccountsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gbpAccountsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.GbpAccountsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.GbpAccountsService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of gbpAccountsServiceStubMethods) {
            const callPromise = this.gbpAccountsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    linkGbpAccount(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    listGbpAccounts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listGbpAccountsStream(request, options) {
        ...
        return this.descriptors.page.listGbpAccounts.createStream(this.innerApiCalls.listGbpAccounts, request, callSettings);
    }
    /**
    ...
    listGbpAccountsAsync(request, options) {
        ...
        return this.descriptors.page.listGbpAccounts.asyncIterate(this.innerApiCalls['listGbpAccounts'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.GbpAccountsServiceClient = GbpAccountsServiceClient;
//# sourceMappingURL=gbp_accounts_service_client.js.map