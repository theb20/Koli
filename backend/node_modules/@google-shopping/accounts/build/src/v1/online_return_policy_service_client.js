...
exports.OnlineReturnPolicyServiceClient = void 0;
 ...
 */
const gapicConfig = require("./online_return_policy_service_client_config.json");
...
class OnlineReturnPolicyServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listOnlineReturnPolicies: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'onlineReturnPolicies')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.OnlineReturnPolicyService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.onlineReturnPolicyServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.OnlineReturnPolicyService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.OnlineReturnPolicyService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const onlineReturnPolicyServiceStubMethods = ['getOnlineReturnPolicy', 'listOnlineReturnPolicies', 'createOnlineReturnPolicy', 'deleteOnlineReturnPolicy'];
        for (const methodName of onlineReturnPolicyServiceStubMethods) {
            const callPromise = this.onlineReturnPolicyServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getOnlineReturnPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createOnlineReturnPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    deleteOnlineReturnPolicy(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listOnlineReturnPolicies(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    listOnlineReturnPoliciesStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listOnlineReturnPolicies.createStream(this.innerApiCalls.listOnlineReturnPolicies, request, callSettings);
    }
    /**
     ...
     */
    listOnlineReturnPoliciesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listOnlineReturnPolicies.asyncIterate(this.innerApiCalls['listOnlineReturnPolicies'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.OnlineReturnPolicyServiceClient = OnlineReturnPolicyServiceClient;
//# sourceMappingURL=online_return_policy_service_client.js.map