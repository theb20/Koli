...
exports.AccountsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./accounts_service_client_config.json");
...
class AccountsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.AccountsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.accountsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.AccountsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.AccountsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const accountsServiceStubMethods = ['getAccount', 'createAndConfigureAccount', 'createTestAccount', 'deleteAccount', 'updateAccount', 'listAccounts', 'listSubAccounts'];
        for (const methodName of accountsServiceStubMethods) {
            const callPromise = this.accountsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createAndConfigureAccount(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    createTestAccount(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listSubAccounts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listSubAccountsStream(request, options) {
        ...
        return this.descriptors.page.listSubAccounts.createStream(this.innerApiCalls.listSubAccounts, request, callSettings);
    }
    /**
    ...
    listSubAccountsAsync(request, options) {
        ...
        return this.descriptors.page.listSubAccounts.asyncIterate(this.innerApiCalls['listSubAccounts'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=accounts_service_client.js.map