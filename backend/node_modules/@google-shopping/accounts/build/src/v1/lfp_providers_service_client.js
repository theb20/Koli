...
exports.LfpProvidersServiceClient = void 0;
 ...
 */
const gapicConfig = require("./lfp_providers_service_client_config.json");
...
class LfpProvidersServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            findLfpProviders: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'lfpProviders')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.LfpProvidersService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.lfpProvidersServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.LfpProvidersService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.LfpProvidersService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const lfpProvidersServiceStubMethods = ['findLfpProviders', 'linkLfpProvider'];
        for (const methodName of lfpProvidersServiceStubMethods) {
            const callPromise = this.lfpProvidersServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    linkLfpProvider(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    findLfpProviders(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    findLfpProvidersStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.findLfpProviders.createStream(this.innerApiCalls.findLfpProviders, request, callSettings);
    }
    /**
     ...
     */
    findLfpProvidersAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.findLfpProviders.asyncIterate(this.innerApiCalls['findLfpProviders'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.LfpProvidersServiceClient = LfpProvidersServiceClient;
//# sourceMappingURL=lfp_providers_service_client.js.map