...
exports.ProgramsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./programs_service_client_config.json");
...
class ProgramsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listPrograms: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'programs')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.ProgramsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.programsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.ProgramsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.ProgramsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const programsServiceStubMethods = ['getProgram', 'listPrograms', 'enableProgram', 'disableProgram'];
        for (const methodName of programsServiceStubMethods) {
            const callPromise = this.programsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getProgram(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    enableProgram(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    disableProgram(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listPrograms(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listProgramsStream(request, options) {
        ...
        return this.descriptors.page.listPrograms.createStream(this.innerApiCalls.listPrograms, request, callSettings);
    }
    /**
    ...
    listProgramsAsync(request, options) {
        ...
        return this.descriptors.page.listPrograms.asyncIterate(this.innerApiCalls['listPrograms'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.ProgramsServiceClient = ProgramsServiceClient;
//# sourceMappingURL=programs_service_client.js.map