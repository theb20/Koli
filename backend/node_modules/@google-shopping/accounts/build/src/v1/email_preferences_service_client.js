...
exports.EmailPreferencesServiceClient = void 0;
 ...
 */
const gapicConfig = require("./email_preferences_service_client_config.json");
...
class EmailPreferencesServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.EmailPreferencesService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.emailPreferencesServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.EmailPreferencesService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.EmailPreferencesService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const emailPreferencesServiceStubMethods = ['getEmailPreferences', 'updateEmailPreferences'];
        for (const methodName of emailPreferencesServiceStubMethods) {
            const callPromise = this.emailPreferencesServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getEmailPreferences(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateEmailPreferences(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.EmailPreferencesServiceClient = EmailPreferencesServiceClient;
//# sourceMappingURL=email_preferences_service_client.js.map