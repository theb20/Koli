 ...
 * @memberof v1
 */
export declare class BusinessIdentityServiceClient {
    private _terminated;
    private _opts;
    ...
    businessIdentityServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     */
    getBusinessIdentity(request?: protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest, options?: CallOptions): Promise<[
    ...
    getBusinessIdentity(request: protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1.IBusinessIdentity, protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest | null | undefined, {} | null | undefined>): void;
    getBusinessIdentity(request: protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1.IBusinessIdentity, protos.google.shopping.merchant.accounts.v1.IGetBusinessIdentityRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    updateBusinessIdentity(request?: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest, options?: CallOptions): Promise<[
        protos.google.shopping.merchant.accounts.v1.IBusinessIdentity,
        protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest | undefined,
        {} | undefined
    ]>;
    updateBusinessIdentity(request: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1.IBusinessIdentity, protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest | null | undefined, {} | null | undefined>): void;
    updateBusinessIdentity(request: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1.IBusinessIdentity, protos.google.shopping.merchant.accounts.v1.IUpdateBusinessIdentityRequest | null | undefined, {} | null | undefined>): void;
    /**
