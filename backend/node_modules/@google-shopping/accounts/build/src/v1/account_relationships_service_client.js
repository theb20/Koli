...
exports.AccountRelationshipsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./account_relationships_service_client_config.json");
...
class AccountRelationshipsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listAccountRelationships: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'accountRelationships')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.AccountRelationshipsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.accountRelationshipsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.AccountRelationshipsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.AccountRelationshipsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const accountRelationshipsServiceStubMethods = ['getAccountRelationship', 'updateAccountRelationship', 'listAccountRelationships'];
        for (const methodName of accountRelationshipsServiceStubMethods) {
            const callPromise = this.accountRelationshipsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAccountRelationship(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateAccountRelationship(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listAccountRelationships(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    listAccountRelationshipsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listAccountRelationships.createStream(this.innerApiCalls.listAccountRelationships, request, callSettings);
    }
    /**
     ...
     */
    listAccountRelationshipsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listAccountRelationships.asyncIterate(this.innerApiCalls['listAccountRelationships'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.AccountRelationshipsServiceClient = AccountRelationshipsServiceClient;
//# sourceMappingURL=account_relationships_service_client.js.map