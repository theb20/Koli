...
exports.TermsOfServiceAgreementStateServiceClient = void 0;
 ...
 */
const gapicConfig = require("./terms_of_service_agreement_state_service_client_config.json");
...
class TermsOfServiceAgreementStateServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.termsOfServiceAgreementStateServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.TermsOfServiceAgreementStateService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const termsOfServiceAgreementStateServiceStubMethods = ['getTermsOfServiceAgreementState', 'retrieveForApplicationTermsOfServiceAgreementState'];
        for (const methodName of termsOfServiceAgreementStateServiceStubMethods) {
            const callPromise = this.termsOfServiceAgreementStateServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getTermsOfServiceAgreementState(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    retrieveForApplicationTermsOfServiceAgreementState(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.TermsOfServiceAgreementStateServiceClient = TermsOfServiceAgreementStateServiceClient;
//# sourceMappingURL=terms_of_service_agreement_state_service_client.js.map