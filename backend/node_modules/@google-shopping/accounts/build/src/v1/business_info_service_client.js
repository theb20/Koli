...
exports.BusinessInfoServiceClient = void 0;
 ...
 */
const gapicConfig = require("./business_info_service_client_config.json");
...
class BusinessInfoServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.BusinessInfoService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.businessInfoServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.BusinessInfoService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.BusinessInfoService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const businessInfoServiceStubMethods = ['getBusinessInfo', 'updateBusinessInfo'];
        for (const methodName of businessInfoServiceStubMethods) {
            const callPromise = this.businessInfoServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getBusinessInfo(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateBusinessInfo(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.BusinessInfoServiceClient = BusinessInfoServiceClient;
//# sourceMappingURL=business_info_service_client.js.map