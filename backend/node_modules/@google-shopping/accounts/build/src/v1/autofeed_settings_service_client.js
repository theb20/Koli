...
exports.AutofeedSettingsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./autofeed_settings_service_client_config.json");
...
class AutofeedSettingsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.AutofeedSettingsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.autofeedSettingsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.AutofeedSettingsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.AutofeedSettingsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const autofeedSettingsServiceStubMethods = ['getAutofeedSettings', 'updateAutofeedSettings'];
        for (const methodName of autofeedSettingsServiceStubMethods) {
            const callPromise = this.autofeedSettingsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAutofeedSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateAutofeedSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.AutofeedSettingsServiceClient = AutofeedSettingsServiceClient;
//# sourceMappingURL=autofeed_settings_service_client.js.map