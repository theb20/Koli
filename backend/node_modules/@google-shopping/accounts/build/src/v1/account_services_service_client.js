...
exports.AccountServicesServiceClient = void 0;
 ...
 */
const gapicConfig = require("./account_services_service_client_config.json");
...
class AccountServicesServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listAccountServices: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'accountServices')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.AccountServicesService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.accountServicesServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.AccountServicesService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.AccountServicesService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const accountServicesServiceStubMethods = ['getAccountService', 'listAccountServices', 'proposeAccountService', 'approveAccountService', 'rejectAccountService'];
        for (const methodName of accountServicesServiceStubMethods) {
            const callPromise = this.accountServicesServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAccountService(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    proposeAccountService(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    approveAccountService(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    rejectAccountService(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listAccountServices(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    listAccountServicesStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listAccountServices.createStream(this.innerApiCalls.listAccountServices, request, callSettings);
    }
    /**
     ...
     */
    listAccountServicesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listAccountServices.asyncIterate(this.innerApiCalls['listAccountServices'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.AccountServicesServiceClient = AccountServicesServiceClient;
//# sourceMappingURL=account_services_service_client.js.map