...
exports.TermsOfServiceServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/terms_of_service_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./terms_of_service_service_client_config.json");
...
class TermsOfServiceServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.TermsOfServiceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.termsOfServiceServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.TermsOfServiceService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.TermsOfServiceService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const termsOfServiceServiceStubMethods = ['getTermsOfService', 'retrieveLatestTermsOfService', 'acceptTermsOfService'];
        for (const methodName of termsOfServiceServiceStubMethods) {
            const callPromise = this.termsOfServiceServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getTermsOfService(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    retrieveLatestTermsOfService(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    acceptTermsOfService(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.TermsOfServiceServiceClient = TermsOfServiceServiceClient;
//# sourceMappingURL=terms_of_service_service_client.js.map