 ...
 * @memberof v1
 */
export declare class AccountIssueServiceClient {
    private _terminated;
    private _opts;
    ...
    accountIssueServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
    ...
    */
    listAccountIssues(request?: protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest, options?: CallOptions): Promise<[
    ...
    listAccountIssues(request: protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest, options: CallOptions, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest, protos.google.shopping.merchant.accounts.v1.IListAccountIssuesResponse | null | undefined, protos.google.shopping.merchant.accounts.v1.IAccountIssue>): void;
    listAccountIssues(request: protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest, protos.google.shopping.merchant.accounts.v1.IListAccountIssuesResponse | null | undefined, protos.google.shopping.merchant.accounts.v1.IAccountIssue>): void;
    /**
     ...
     *   for more details and examples.
     */
    listAccountIssuesStream(request?: protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest, options?: CallOptions): Transform;
    /**
     ...
     */
    listAccountIssuesAsync(request?: protos.google.shopping.merchant.accounts.v1.IListAccountIssuesRequest, options?: CallOptions): AsyncIterable<protos.google.shopping.merchant.accounts.v1.IAccountIssue>;
    /**
