 ...
 * @memberof v1
 */
export declare class GbpAccountsServiceClient {
    private _terminated;
    private _opts;
    ...
    gbpAccountsServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     */
    linkGbpAccount(request?: protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest, options?: CallOptions): Promise<[
    ...
    linkGbpAccount(request: protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountResponse, protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest | null | undefined, {} | null | undefined>): void;
    linkGbpAccount(request: protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountResponse, protos.google.shopping.merchant.accounts.v1.ILinkGbpAccountRequest | null | undefined, {} | null | undefined>): void;
    /**
    ...
    *   for more details and examples.
    */
    listGbpAccounts(request?: protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest, options?: CallOptions): Promise<[
    ...
    listGbpAccounts(request: protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest, options: CallOptions, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest, protos.google.shopping.merchant.accounts.v1.IListGbpAccountsResponse | null | undefined, protos.google.shopping.merchant.accounts.v1.IGbpAccount>): void;
    listGbpAccounts(request: protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest, protos.google.shopping.merchant.accounts.v1.IListGbpAccountsResponse | null | undefined, protos.google.shopping.merchant.accounts.v1.IGbpAccount>): void;
    /**
     ...
     *   for more details and examples.
     */
    listGbpAccountsStream(request?: protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest, options?: CallOptions): Transform;
    /**
     ...
     */
    listGbpAccountsAsync(request?: protos.google.shopping.merchant.accounts.v1.IListGbpAccountsRequest, options?: CallOptions): AsyncIterable<protos.google.shopping.merchant.accounts.v1.IGbpAccount>;
    /**
