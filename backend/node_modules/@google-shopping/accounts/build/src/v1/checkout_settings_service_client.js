...
exports.CheckoutSettingsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./checkout_settings_service_client_config.json");
...
class CheckoutSettingsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.CheckoutSettingsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.checkoutSettingsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.CheckoutSettingsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.CheckoutSettingsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const checkoutSettingsServiceStubMethods = ['getCheckoutSettings', 'createCheckoutSettings', 'updateCheckoutSettings', 'deleteCheckoutSettings'];
        for (const methodName of checkoutSettingsServiceStubMethods) {
            const callPromise = this.checkoutSettingsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getCheckoutSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createCheckoutSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateCheckoutSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    deleteCheckoutSettings(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.CheckoutSettingsServiceClient = CheckoutSettingsServiceClient;
//# sourceMappingURL=checkout_settings_service_client.js.map