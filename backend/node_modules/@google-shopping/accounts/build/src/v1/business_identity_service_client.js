...
exports.BusinessIdentityServiceClient = void 0;
 ...
 */
const gapicConfig = require("./business_identity_service_client_config.json");
...
class BusinessIdentityServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.BusinessIdentityService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.businessIdentityServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.BusinessIdentityService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.BusinessIdentityService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const businessIdentityServiceStubMethods = ['getBusinessIdentity', 'updateBusinessIdentity'];
        for (const methodName of businessIdentityServiceStubMethods) {
            const callPromise = this.businessIdentityServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getBusinessIdentity(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateBusinessIdentity(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.BusinessIdentityServiceClient = BusinessIdentityServiceClient;
//# sourceMappingURL=business_identity_service_client.js.map