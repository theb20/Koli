...
exports.RegionsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./regions_service_client_config.json");
...
class RegionsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listRegions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'regions')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.RegionsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.regionsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.RegionsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.RegionsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const regionsServiceStubMethods = ['getRegion', 'createRegion', 'batchCreateRegions', 'updateRegion', 'batchUpdateRegions', 'deleteRegion', 'batchDeleteRegions', 'listRegions'];
        for (const methodName of regionsServiceStubMethods) {
            const callPromise = this.regionsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getRegion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createRegion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    batchCreateRegions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateRegion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    batchUpdateRegions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    deleteRegion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    batchDeleteRegions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listRegions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    listRegionsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listRegions.createStream(this.innerApiCalls.listRegions, request, callSettings);
    }
    /**
     ...
     */
    listRegionsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listRegions.asyncIterate(this.innerApiCalls['listRegions'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.RegionsServiceClient = RegionsServiceClient;
//# sourceMappingURL=regions_service_client.js.map