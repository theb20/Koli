...
exports.AccountIssueServiceClient = void 0;
 ...
 */
const gapicConfig = require("./account_issue_service_client_config.json");
...
class AccountIssueServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listAccountIssues: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'accountIssues')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.AccountIssueService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.accountIssueServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.AccountIssueService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.AccountIssueService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of accountIssueServiceStubMethods) {
            const callPromise = this.accountIssueServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listAccountIssues(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    listAccountIssuesStream(request, options) {
        ...
        return this.descriptors.page.listAccountIssues.createStream(this.innerApiCalls.listAccountIssues, request, callSettings);
    }
    /**
    ...
    listAccountIssuesAsync(request, options) {
        ...
        return this.descriptors.page.listAccountIssues.asyncIterate(this.innerApiCalls['listAccountIssues'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.AccountIssueServiceClient = AccountIssueServiceClient;
//# sourceMappingURL=account_issue_service_client.js.map