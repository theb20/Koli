 ...
 * @memberof v1
 */
export declare class BusinessInfoServiceClient {
    private _terminated;
    private _opts;
    ...
    businessInfoServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     */
    getBusinessInfo(request?: protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest, options?: CallOptions): Promise<[
    ...
    getBusinessInfo(request: protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1.IBusinessInfo, protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest | null | undefined, {} | null | undefined>): void;
    getBusinessInfo(request: protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1.IBusinessInfo, protos.google.shopping.merchant.accounts.v1.IGetBusinessInfoRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    updateBusinessInfo(request?: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest, options?: CallOptions): Promise<[
        protos.google.shopping.merchant.accounts.v1.IBusinessInfo,
        protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest | undefined,
        {} | undefined
    ]>;
    updateBusinessInfo(request: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1.IBusinessInfo, protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest | null | undefined, {} | null | undefined>): void;
    updateBusinessInfo(request: protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1.IBusinessInfo, protos.google.shopping.merchant.accounts.v1.IUpdateBusinessInfoRequest | null | undefined, {} | null | undefined>): void;
    /**
