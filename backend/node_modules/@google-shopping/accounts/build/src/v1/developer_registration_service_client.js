...
exports.DeveloperRegistrationServiceClient = void 0;
 ...
 */
const gapicConfig = require("./developer_registration_service_client_config.json");
...
class DeveloperRegistrationServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.DeveloperRegistrationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.developerRegistrationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.DeveloperRegistrationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.DeveloperRegistrationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const developerRegistrationServiceStubMethods = ['registerGcp', 'getDeveloperRegistration', 'unregisterGcp', 'getAccountForGcpRegistration'];
        for (const methodName of developerRegistrationServiceStubMethods) {
            const callPromise = this.developerRegistrationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    registerGcp(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getDeveloperRegistration(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    unregisterGcp(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getAccountForGcpRegistration(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.DeveloperRegistrationServiceClient = DeveloperRegistrationServiceClient;
//# sourceMappingURL=developer_registration_service_client.js.map