 ...
 * @memberof v1
 */
export declare class AutomaticImprovementsServiceClient {
    private _terminated;
    private _opts;
    ...
    automaticImprovementsServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     */
    getAutomaticImprovements(request?: protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest, options?: CallOptions): Promise<[
    ...
    getAutomaticImprovements(request: protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements, protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest | null | undefined, {} | null | undefined>): void;
    getAutomaticImprovements(request: protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements, protos.google.shopping.merchant.accounts.v1.IGetAutomaticImprovementsRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    updateAutomaticImprovements(request?: protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest, options?: CallOptions): Promise<[
        protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements,
        protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest | undefined,
        {} | undefined
    ]>;
    updateAutomaticImprovements(request: protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements, protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest | null | undefined, {} | null | undefined>): void;
    updateAutomaticImprovements(request: protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1.IAutomaticImprovements, protos.google.shopping.merchant.accounts.v1.IUpdateAutomaticImprovementsRequest | null | undefined, {} | null | undefined>): void;
    /**
