...
exports.AutomaticImprovementsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./automatic_improvements_service_client_config.json");
...
class AutomaticImprovementsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1.AutomaticImprovementsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.automaticImprovementsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1.AutomaticImprovementsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1.AutomaticImprovementsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const automaticImprovementsServiceStubMethods = ['getAutomaticImprovements', 'updateAutomaticImprovements'];
        for (const methodName of automaticImprovementsServiceStubMethods) {
            const callPromise = this.automaticImprovementsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAutomaticImprovements(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateAutomaticImprovements(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.AutomaticImprovementsServiceClient = AutomaticImprovementsServiceClient;
//# sourceMappingURL=automatic_improvements_service_client.js.map