 ...
 * @memberof v1
 */
export declare class LfpProvidersServiceClient {
    private _terminated;
    private _opts;
    ...
    lfpProvidersServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     */
    linkLfpProvider(request?: protos.google.shopping.merchant.accounts.v1.ILinkLfpProviderRequest, options?: CallOptions): Promise<[
    ...
    linkLfpProvider(request: protos.google.shopping.merchant.accounts.v1.ILinkLfpProviderRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1.ILinkLfpProviderResponse, protos.google.shopping.merchant.accounts.v1.ILinkLfpProviderRequest | null | undefined, {} | null | undefined>): void;
    linkLfpProvider(request: protos.google.shopping.merchant.accounts.v1.ILinkLfpProviderRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1.ILinkLfpProviderResponse, protos.google.shopping.merchant.accounts.v1.ILinkLfpProviderRequest | null | undefined, {} | null | undefined>): void;
    /**
    ...
    *   for more details and examples.
    */
    findLfpProviders(request?: protos.google.shopping.merchant.accounts.v1.IFindLfpProvidersRequest, options?: CallOptions): Promise<[
    ...
    findLfpProviders(request: protos.google.shopping.merchant.accounts.v1.IFindLfpProvidersRequest, options: CallOptions, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1.IFindLfpProvidersRequest, protos.google.shopping.merchant.accounts.v1.IFindLfpProvidersResponse | null | undefined, protos.google.shopping.merchant.accounts.v1.ILfpProvider>): void;
    findLfpProviders(request: protos.google.shopping.merchant.accounts.v1.IFindLfpProvidersRequest, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1.IFindLfpProvidersRequest, protos.google.shopping.merchant.accounts.v1.IFindLfpProvidersResponse | null | undefined, protos.google.shopping.merchant.accounts.v1.ILfpProvider>): void;
    /**
     ...
     *   for more details and examples.
     */
    findLfpProvidersStream(request?: protos.google.shopping.merchant.accounts.v1.IFindLfpProvidersRequest, options?: CallOptions): Transform;
    /**
     ...
     */
    findLfpProvidersAsync(request?: protos.google.shopping.merchant.accounts.v1.IFindLfpProvidersRequest, options?: CallOptions): AsyncIterable<protos.google.shopping.merchant.accounts.v1.ILfpProvider>;
    /**
