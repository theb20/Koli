...
export declare class ShippingSettingsServiceClient {
     ...
     */
    getShippingSettings(request?: protos.google.shopping.merchant.accounts.v1beta.IGetShippingSettingsRequest, options?: CallOptions): Promise<[
    ...
    getShippingSettings(request: protos.google.shopping.merchant.accounts.v1beta.IGetShippingSettingsRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.IShippingSettings, protos.google.shopping.merchant.accounts.v1beta.IGetShippingSettingsRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    insertShippingSettings(request?: protos.google.shopping.merchant.accounts.v1beta.IInsertShippingSettingsRequest, options?: CallOptions): Promise<[
        protos.google.shopping.merchant.accounts.v1beta.IShippingSettings,
        protos.google.shopping.merchant.accounts.v1beta.IInsertShippingSettingsRequest | undefined,
        {} | undefined
    ]>;
    insertShippingSettings(request: protos.google.shopping.merchant.accounts.v1beta.IInsertShippingSettingsRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.IShippingSettings, protos.google.shopping.merchant.accounts.v1beta.IInsertShippingSettingsRequest | null | undefined, {} | null | undefined>): void;
    insertShippingSettings(request: protos.google.shopping.merchant.accounts.v1beta.IInsertShippingSettingsRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.IShippingSettings, protos.google.shopping.merchant.accounts.v1beta.IInsertShippingSettingsRequest | null | undefined, {} | null | undefined>): void;
    /**
