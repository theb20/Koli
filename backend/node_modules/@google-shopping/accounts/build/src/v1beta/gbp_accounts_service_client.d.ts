...
export declare class GbpAccountsServiceClient {
     ...
     */
    linkGbpAccount(request?: protos.google.shopping.merchant.accounts.v1beta.ILinkGbpAccountRequest, options?: CallOptions): Promise<[
    ...
    linkGbpAccount(request: protos.google.shopping.merchant.accounts.v1beta.ILinkGbpAccountRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.ILinkGbpAccountResponse, protos.google.shopping.merchant.accounts.v1beta.ILinkGbpAccountRequest | null | undefined, {} | null | undefined>): void;
    linkGbpAccount(request: protos.google.shopping.merchant.accounts.v1beta.ILinkGbpAccountRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.ILinkGbpAccountResponse, protos.google.shopping.merchant.accounts.v1beta.ILinkGbpAccountRequest | null | undefined, {} | null | undefined>): void;
    /**
    ...
    *   for more details and examples.
    */
    listGbpAccounts(request?: protos.google.shopping.merchant.accounts.v1beta.IListGbpAccountsRequest, options?: CallOptions): Promise<[
    ...
    listGbpAccounts(request: protos.google.shopping.merchant.accounts.v1beta.IListGbpAccountsRequest, options: CallOptions, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1beta.IListGbpAccountsRequest, protos.google.shopping.merchant.accounts.v1beta.IListGbpAccountsResponse | null | undefined, protos.google.shopping.merchant.accounts.v1beta.IGbpAccount>): void;
    listGbpAccounts(request: protos.google.shopping.merchant.accounts.v1beta.IListGbpAccountsRequest, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1beta.IListGbpAccountsRequest, protos.google.shopping.merchant.accounts.v1beta.IListGbpAccountsResponse | null | undefined, protos.google.shopping.merchant.accounts.v1beta.IGbpAccount>): void;
    /**
     ...
     *   for more details and examples.
     */
    listGbpAccountsStream(request?: protos.google.shopping.merchant.accounts.v1beta.IListGbpAccountsRequest, options?: CallOptions): Transform;
    /**
     ...
     */
    listGbpAccountsAsync(request?: protos.google.shopping.merchant.accounts.v1beta.IListGbpAccountsRequest, options?: CallOptions): AsyncIterable<protos.google.shopping.merchant.accounts.v1beta.IGbpAccount>;
    /**
