...
export declare class AccountIssueServiceClient {
    ...
    */
    listAccountIssues(request?: protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest, options?: CallOptions): Promise<[
    ...
    listAccountIssues(request: protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest, options: CallOptions, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest, protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesResponse | null | undefined, protos.google.shopping.merchant.accounts.v1beta.IAccountIssue>): void;
    listAccountIssues(request: protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest, protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesResponse | null | undefined, protos.google.shopping.merchant.accounts.v1beta.IAccountIssue>): void;
    /**
     ...
     *   for more details and examples.
     */
    listAccountIssuesStream(request?: protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest, options?: CallOptions): Transform;
    /**
     ...
     */
    listAccountIssuesAsync(request?: protos.google.shopping.merchant.accounts.v1beta.IListAccountIssuesRequest, options?: CallOptions): AsyncIterable<protos.google.shopping.merchant.accounts.v1beta.IAccountIssue>;
    /**
