 ...
 * @memberof v1beta
 */
export declare class AutofeedSettingsServiceClient {
    private _terminated;
    private _opts;
    ...
    autofeedSettingsServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     */
    getAutofeedSettings(request?: protos.google.shopping.merchant.accounts.v1beta.IGetAutofeedSettingsRequest, options?: CallOptions): Promise<[
    ...
    getAutofeedSettings(request: protos.google.shopping.merchant.accounts.v1beta.IGetAutofeedSettingsRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.IAutofeedSettings, protos.google.shopping.merchant.accounts.v1beta.IGetAutofeedSettingsRequest | null | undefined, {} | null | undefined>): void;
    getAutofeedSettings(request: protos.google.shopping.merchant.accounts.v1beta.IGetAutofeedSettingsRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.IAutofeedSettings, protos.google.shopping.merchant.accounts.v1beta.IGetAutofeedSettingsRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    updateAutofeedSettings(request?: protos.google.shopping.merchant.accounts.v1beta.IUpdateAutofeedSettingsRequest, options?: CallOptions): Promise<[
        protos.google.shopping.merchant.accounts.v1beta.IAutofeedSettings,
        protos.google.shopping.merchant.accounts.v1beta.IUpdateAutofeedSettingsRequest | undefined,
        {} | undefined
    ]>;
    updateAutofeedSettings(request: protos.google.shopping.merchant.accounts.v1beta.IUpdateAutofeedSettingsRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.IAutofeedSettings, protos.google.shopping.merchant.accounts.v1beta.IUpdateAutofeedSettingsRequest | null | undefined, {} | null | undefined>): void;
    updateAutofeedSettings(request: protos.google.shopping.merchant.accounts.v1beta.IUpdateAutofeedSettingsRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.IAutofeedSettings, protos.google.shopping.merchant.accounts.v1beta.IUpdateAutofeedSettingsRequest | null | undefined, {} | null | undefined>): void;
    /**
