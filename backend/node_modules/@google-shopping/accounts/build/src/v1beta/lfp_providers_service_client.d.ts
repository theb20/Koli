...
export declare class LfpProvidersServiceClient {
     ...
     */
    linkLfpProvider(request?: protos.google.shopping.merchant.accounts.v1beta.ILinkLfpProviderRequest, options?: CallOptions): Promise<[
    ...
    linkLfpProvider(request: protos.google.shopping.merchant.accounts.v1beta.ILinkLfpProviderRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.ILinkLfpProviderResponse, protos.google.shopping.merchant.accounts.v1beta.ILinkLfpProviderRequest | null | undefined, {} | null | undefined>): void;
    linkLfpProvider(request: protos.google.shopping.merchant.accounts.v1beta.ILinkLfpProviderRequest, callback: Callback<protos.google.shopping.merchant.accounts.v1beta.ILinkLfpProviderResponse, protos.google.shopping.merchant.accounts.v1beta.ILinkLfpProviderRequest | null | undefined, {} | null | undefined>): void;
    /**
    ...
    *   for more details and examples.
    */
    findLfpProviders(request?: protos.google.shopping.merchant.accounts.v1beta.IFindLfpProvidersRequest, options?: CallOptions): Promise<[
    ...
    findLfpProviders(request: protos.google.shopping.merchant.accounts.v1beta.IFindLfpProvidersRequest, options: CallOptions, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1beta.IFindLfpProvidersRequest, protos.google.shopping.merchant.accounts.v1beta.IFindLfpProvidersResponse | null | undefined, protos.google.shopping.merchant.accounts.v1beta.ILfpProvider>): void;
    findLfpProviders(request: protos.google.shopping.merchant.accounts.v1beta.IFindLfpProvidersRequest, callback: PaginationCallback<protos.google.shopping.merchant.accounts.v1beta.IFindLfpProvidersRequest, protos.google.shopping.merchant.accounts.v1beta.IFindLfpProvidersResponse | null | undefined, protos.google.shopping.merchant.accounts.v1beta.ILfpProvider>): void;
    /**
     ...
     *   for more details and examples.
     */
    findLfpProvidersStream(request?: protos.google.shopping.merchant.accounts.v1beta.IFindLfpProvidersRequest, options?: CallOptions): Transform;
    /**
     ...
     */
    findLfpProvidersAsync(request?: protos.google.shopping.merchant.accounts.v1beta.IFindLfpProvidersRequest, options?: CallOptions): AsyncIterable<protos.google.shopping.merchant.accounts.v1beta.ILfpProvider>;
    /**
