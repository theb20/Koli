...
exports.AccountTaxServiceClient = void 0;
 ...
 */
const gapicConfig = require("./account_tax_service_client_config.json");
...
class AccountTaxServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listAccountTax: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'accountTaxes')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1beta.AccountTaxService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.accountTaxServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1beta.AccountTaxService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1beta.AccountTaxService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const accountTaxServiceStubMethods = ['getAccountTax', 'listAccountTax', 'updateAccountTax'];
        for (const methodName of accountTaxServiceStubMethods) {
            const callPromise = this.accountTaxServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getAccountTax(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateAccountTax(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listAccountTax(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listAccountTaxStream(request, options) {
        ...
        return this.descriptors.page.listAccountTax.createStream(this.innerApiCalls.listAccountTax, request, callSettings);
    }
    /**
    ...
    listAccountTaxAsync(request, options) {
        ...
        return this.descriptors.page.listAccountTax.asyncIterate(this.innerApiCalls['listAccountTax'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.AccountTaxServiceClient = AccountTaxServiceClient;
//# sourceMappingURL=account_tax_service_client.js.map