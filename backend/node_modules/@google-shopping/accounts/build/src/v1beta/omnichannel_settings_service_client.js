...
class OmnichannelSettingsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            accountTaxPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/accounttax/{tax}'),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.omnichannelSettingsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.accounts.v1beta.OmnichannelSettingsService, this._opts, this._providedCustomServicePath);
