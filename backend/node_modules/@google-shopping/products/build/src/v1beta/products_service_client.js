...
exports.ProductsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./products_service_client_config.json");
...
class ProductsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.products.v1beta.ProductsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.productsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.products.v1beta.ProductsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.products.v1beta.ProductsService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of productsServiceStubMethods) {
            const callPromise = this.productsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=products_service_client.js.map