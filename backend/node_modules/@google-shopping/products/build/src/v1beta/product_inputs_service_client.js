...
exports.ProductInputsServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/product_inputs_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./product_inputs_service_client_config.json");
...
class ProductInputsServiceClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('products');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            productPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/products/{product}'),
            productInputPathTemplate: new this._gaxModule.PathTemplate('accounts/{account}/productInputs/{productinput}'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.shopping.merchant.products.v1beta.ProductInputsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.productInputsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.shopping.merchant.products.v1beta.ProductInputsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.shopping.merchant.products.v1beta.ProductInputsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const productInputsServiceStubMethods = ['insertProductInput', 'updateProductInput', 'deleteProductInput'];
        for (const methodName of productInputsServiceStubMethods) {
            const callPromise = this.productInputsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    insertProductInput(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateProductInput(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    deleteProductInput(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
exports.ProductInputsServiceClient = ProductInputsServiceClient;
//# sourceMappingURL=product_inputs_service_client.js.map