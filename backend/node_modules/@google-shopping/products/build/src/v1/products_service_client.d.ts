 ...
 * @memberof v1
 */
export declare class ProductsServiceClient {
    private _terminated;
    private _opts;
     ...
     */
    getProduct(request?: protos.google.shopping.merchant.products.v1.IGetProductRequest, options?: CallOptions): Promise<[
    ...
    getProduct(request: protos.google.shopping.merchant.products.v1.IGetProductRequest, options: CallOptions, callback: Callback<protos.google.shopping.merchant.products.v1.IProduct, protos.google.shopping.merchant.products.v1.IGetProductRequest | null | undefined, {} | null | undefined>): void;
    getProduct(request: protos.google.shopping.merchant.products.v1.IGetProductRequest, callback: Callback<protos.google.shopping.merchant.products.v1.IProduct, protos.google.shopping.merchant.products.v1.IGetProductRequest | null | undefined, {} | null | undefined>): void;
    /**
    ...
    *   for more details and examples.
    */
    listProducts(request?: protos.google.shopping.merchant.products.v1.IListProductsRequest, options?: CallOptions): Promise<[
        protos.google.shopping.merchant.products.v1.IProduct[],
    ...
    listProducts(request: protos.google.shopping.merchant.products.v1.IListProductsRequest, options: CallOptions, callback: PaginationCallback<protos.google.shopping.merchant.products.v1.IListProductsRequest, protos.google.shopping.merchant.products.v1.IListProductsResponse | null | undefined, protos.google.shopping.merchant.products.v1.IProduct>): void;
    listProducts(request: protos.google.shopping.merchant.products.v1.IListProductsRequest, callback: PaginationCallback<protos.google.shopping.merchant.products.v1.IListProductsRequest, protos.google.shopping.merchant.products.v1.IListProductsResponse | null | undefined, protos.google.shopping.merchant.products.v1.IProduct>): void;
    /**
     ...
     *   for more details and examples.
     */
    listProductsStream(request?: protos.google.shopping.merchant.products.v1.IListProductsRequest, options?: CallOptions): Transform;
    /**
     ...
     */
    listProductsAsync(request?: protos.google.shopping.merchant.products.v1.IListProductsRequest, options?: CallOptions): AsyncIterable<protos.google.shopping.merchant.products.v1.IProduct>;
    /**
